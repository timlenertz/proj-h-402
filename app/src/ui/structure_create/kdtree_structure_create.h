#ifndef DYPC_UI_KDTREE_STRUCTURE_CREATE_H_
#define DYPC_UI_KDTREE_STRUCTURE_CREATE_H_

#include "../../../res/kdtree_structure_create.h"
...
class kdtree_structure_create : public kdtree_structure_create_ui, public structure_create_panel {	
public:
	kdtree_structure_create(wxWindow* parent = nullptr, wxWindowID id = wxID_ANY) : kdtree_structure_create_ui(parent, id) { }
