#ifndef DYPC_TREE_STRUCTURE_MEMORY_SIMPLE_LOADER_H_
#define DYPC_TREE_STRUCTURE_MEMORY_SIMPLE_LOADER_H_
...
class tree_structure_memory_simple_loader : public tree_structure_loader {
private:
	Structure structure_;

public:
	template<class... Args> tree_structure_memory_simple_loader(Args&&... args) : structure_(std::forward<Args>(args)...) { }
...
template<class Structure>
std::size_t tree_structure_memory_simple_loader<Structure>::extract_node_points_(point_buffer_t points, std::size_t capacity, const loader::request_t& req, const typename Structure::node& nd, const cuboid& cub, unsigned depth) const {
