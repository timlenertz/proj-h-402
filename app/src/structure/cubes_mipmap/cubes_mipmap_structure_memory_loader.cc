...
std::size_t cubes_mipmap_structure_memory_loader::memory_size_() const {
	return structure_.size();
}

std::size_t cubes_mipmap_structure_memory_loader::file_size_() const {
	return 0;
}

std::size_t cubes_mipmap_structure_memory_loader::total_points_() const {
