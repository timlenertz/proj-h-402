 ...
 * A two-function interface for getting/setting the various settings of the loaders is provided. (@see get_setting @see set_setting). This base class provides the setting \c adaptive which can be 1 or 0 (@see get_adaptive). The subclasses provide additional settings.
 */
class loader {
protected:
	bool adaptive_ = true; ///< Whether the loader is adaptive
