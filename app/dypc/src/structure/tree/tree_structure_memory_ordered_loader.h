#ifndef DYPC_TREE_STRUCTURE_MEMORY_ORDERED_LOADER_H_
#define DYPC_TREE_STRUCTURE_MEMORY_ORDERED_LOADER_H_
...
class tree_structure_memory_ordered_loader : public tree_structure_loader {
private:
	struct path_entry {
...
public:
	explicit tree_structure_memory_ordered_loader(const Structure* s) : structure_(s) {
...
template<class Structure>
std::size_t tree_structure_memory_ordered_loader<Structure>::extract_points_(point_buffer_t points, std::size_t capacity, const loader::request_t& req) {
...
template<class Structure>
std::size_t tree_structure_memory_ordered_loader<Structure>::extract_node_points_(point_buffer_t points, std::size_t capacity, const loader::request_t& req, const typename Structure::node& nd, const cuboid& cub, unsigned depth, std::ptrdiff_t exclude_child_index) const {
